			...
			<div class="container">
				...
				<div class="row">
					...
					<c:forEach var="groom" items="${groomlist}">
						<div class="col-xs-3">
							<a href="lms/toexamintroduce.action?competionId=-1&examId=${groom.id}" class=""><img src="${(empty groom.imgpath)?'images/exam.jpg':groom.imgpath}" class="img-thumbnail"><h4>${groom.name}</h4></a>
						</div>
					</c:forEach>
				</div>
				<div class="clear"></div>
			...
			$
					.ajax({
						...
						success : function(s) {
							...
							if (row.length > 0)
							{
								tmp2 = "<a href='lms/examlist.action?currentpage=1&c="+categoryId+"&r=0'><img src='images/more.png'/></a>";
