  ...
  <section class="content">
    <article class="content-primary" role="main">
      ...
      <div class="introduction">
        ...
        <div class="copy">
          <p>您可以导出试卷并在云考试平台之外编辑它们。导出的文件是word类型的文件 ，包含试卷结构和内容。</p>
        </div>
      </div>
      ...
      <div class="export-controls">
        ...
        <ul class="list-actions">
          <li class="item-action">
            <a class="action action-export action-primary" href="cms/exportExamword.action?examId=${examId}">
    ...
    <aside class="content-supplementary" role="complimentary">
      <div class="bit">
        ...
        <p>您或许想在云考试平台之外直接编辑试卷的Word，或想为您的试卷建立备份，或想复制一份试卷供日后导入进另一个试卷实例和修改。</p>
      </div>
